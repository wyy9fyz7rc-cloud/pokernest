...
import { Plus, Check, ChevronLeft, ArrowRight, RotateCcw, Trophy, Users } from "lucide-react";
...
export default function App() {
  ...
  useEffect(() => {
    ensureSignedIn()
      .then(() => setAuthed(true))
      .catch((e) => console.error("サインインに失敗しました", e));
  }, []);

  useEffect(() => {
    if (authed && !membersLoading && step === "loading") setStep("home");
  }, [authed, membersLoading, step]);
        ...
        {step === "home" && (
          <div className="p-6 overflow-y-auto h-full">
            <div className="flex items-baseline justify-between">
              ...
              <div className="w-9 h-9 rounded-full bg-[#16231C] text-white flex items-center justify-center text-sm">
                た
              </div>
            </div>
